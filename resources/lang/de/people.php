...
return [
    ...
    'people_list_search' => 'Suche einen Kontakt via Name',
    'people_list_firstnameAZ' => 'Sortiere nach Vorname A → Z',
    'people_list_firstnameZA' => 'Sortiere nach Vorname Z → A',
    'people_list_lastnameAZ' => 'Sortiere nach Nachname A → Z',
    'people_list_lastnameZA' => 'Sortiere nach Nachname Z → A',

    // people add
    'people_add_title' => 'Füge eine neue Person hinzu',
    'people_add_firstname' => 'Vorname',
    'people_add_middlename' => 'Mittlerer Name (Optional)',
    'people_add_lastname' => 'Nachname (Optional)',
    'people_add_cta' => 'Füge die Person hinzu',
    'people_add_gender' => 'Geschlecht',
    'people_delete_success' => 'Der Kontakt wurde gelöscht',
    'people_delete_message' => 'Wenn Du diesen Kontakt löschen willst,',
    'people_delete_click_here' => 'klicke hier',
    'people_delete_confirmation' => 'Are you sure you want to delete this contact? Deletion is permanent.',
    'people_add_birthday_reminder' => 'Wünsche :name alles Gute zum Geburtstag',
